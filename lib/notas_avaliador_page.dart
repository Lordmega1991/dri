...
class NotasAvaliadorPage extends StatefulWidget {
  final Map<String, dynamic> defesa;

  const NotasAvaliadorPage({super.key, required this.defesa});

  @override
  State<NotasAvaliadorPage> createState() => _NotasAvaliadorPageState();
}

class _NotasAvaliadorPageState extends State<NotasAvaliadorPage> {
